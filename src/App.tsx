          ...
          >
            ...
            <div className="aspect-[4/5] bg-neutral-900 border border-white/5 rounded-sm overflow-hidden relative group">
              ...
              <img 
                src="/safin-photo.jpg" 
                alt="Safin Yasar" 
                className="absolute inset-0 w-full h-full object-cover z-30 transition-all duration-700"
                onError={(e) => {
              ...
              <div className="hidden absolute inset-0 flex flex-col items-center justify-center p-12 text-center z-20">
